...
<html>
  <head>
    ...
    <title>Confirma&ccedil;&atilde;o de exclus&atilde;o</title>
    <link
  ...
  <body>
    ...
    <div class="container conteudo-main">
      <h2 class="text-danger">
        Tem certeza que deseja remover este usu&aacute;rio?
      </h2>
      ...
      <form action="/usuarios/remover" method="post">
        <div class="mb-3">
          ...
          <div>
            <a href="/usuarios/lista">N&atilde;o, retornar para a lista</a> |
